                        ...
                        <div className={styles.textBox}>
                            <h2>Initial Enquiry</h2>
                                <p>Following an email or telephone enquiry I’ll contact you to ask some brief details about your plans for the garden, timings and key requirements.
                                    I will then arrange a site visit to walk through the garden area with you and your builder to gain a more detailed perspective. I may send you 
                                    a questionnaire in advance to help you think through all the aspects of what you need or we can go through it at the site.
                    ...
                    <div className={styles.iconTextBox}>
                        ...
                        <div className={styles.textBox}>
                            <h2>The Planting Plan</h2>
                                ...
                                Whilst I am happy to provide a planting scheme that can be managed as easily as you require, I do like to encourage your 
                                involvement in the future progression of your garden and will also provide suggestions for seasonal planting additions.</p>
                        </div>
                    </div>
                    <div className={styles.iconTextBox}>
                        <div className={styles.iconBox}>
                        ...
                        <div className={styles.textBox}>
                            <h2>The Plant purchase and planting day</h2>
                                ...
                                I am also available to visit garden centres with you if you would find that helpful when adding seasonal plants to your new planning scheme.</p>
                        </div>
                    </div>
                    <div className={styles.iconTextBox}>
                        <div className={styles.iconBox}>
